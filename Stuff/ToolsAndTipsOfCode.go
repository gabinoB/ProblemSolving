/*  //Estructura basica de un archivo basico GO.
package main
...
line, _ := in.ReadString('\n')   //En "line" es donde se guarda la string ingresada por input.

// Si se ingresó un numero como string y se lo desea convertir a float64:

valueYetStringType = strings.TrimSpace(line) //Quita el espacio al final de la string para poder convertirlo correctamente a float.
valueConvertedToFloat64, _ := strconv.ParseFloat(valueYetStringType, 8)
